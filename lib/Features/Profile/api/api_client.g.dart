...
class _ProfileApiClient implements ProfileApiClient {
  ...
  @override
  Future<EditUserDto> editUserData(EditRequest user) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(user.toJson());
    final _options = _setStreamType<EditUserDto>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late EditUserDto _value;
    try {
      _value = EditUserDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
